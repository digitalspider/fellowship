...
const GospelSection = (props) => {
  return (
    <div>
      <h2>God </h2>
      <p>The Bible teaches us that there is only one true, eternal, and holy God. He is the all-powerful Creator and just Judge to whom we are all accountable:</p>
      <p>"... without faith it is impossible to please Him, for he who comes to God must believe that He is, and that He is a rewarder of those who diligently seek Him." - <BibleVerse reference="HEB.11.6" text="Hebrews 11:6"/></p>

      <h2>Man</h2>
      <p>From the Bible we learn that we are made by God, and that He deserves our full obedience:</p>
      <p>"... the LORD God formed man of the dust of the ground, and breathed into his nostrils the breath of life; and man became a living being." - <BibleVerse reference="GEN.2.7" text="Genesis 2:7"/></p>

      <h2>Sin</h2>
      <p>From the Bible we learn that we have all sinned against God and deserve His righteous punishment:</p>
