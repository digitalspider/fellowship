...
const WhatsOnSection = (props) => {
  return (
    <div>
      ...
      <p>The Martinovici Family serve at the Sola Scriptura Romanian Baptist Church, where Elijah is the pastor. The church's website is www.solascriptura.org.au</p>
      
      
      
      
      <h2>Chris and Fiona Tyrrell - Teaching English in Rwanda</h2>
      <p>C___F_photo_P1000740</p>
