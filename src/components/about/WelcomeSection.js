    ...
    <div>
      ...
      <p>
        <div>
          ...
          <p><img width="200" height="132" align="right" alt="_MG_4519" src="http://fellowship.org.au/site/user/images/_MG_4519.JPG"></img></p>
          <h2>as a loving</h2>
          <p>Our call to love and care for one another and the community</p>
          <p><img align="left" class="imgLeft" alt="IMG_4444" src="http://fellowship.org.au/site/user/images/IMG_4444_2.JPG"></img></p>
          <h2>fellowship</h2>
          <p>Magnifying our unity and identity as brothers and sisters in Christ</p>
          <p>
            <img width="200" height="163" align="right" alt="IMG_4478" src="http://fellowship.org.au/site/user/images/IMG_4478.JPG"></img>
          </p>
          <h2>of Christlike</h2>
          <p>
          Maturity in Christ is our goal as a corporate body and individual believers
          </p>
          <p><img width="133" height="200" align="left" class="imgLeft" alt="_MG_4524" src="http://fellowship.org.au/site/user/images/_MG_4524.jpg"></img></p>
          <h2>disciplemakers&nbsp;</h2>
          <p>Our commission to evangelize and nurture new believers</p>
          <p><img align="right" alt="IMG_4443" src="http://fellowship.org.au/site/user/images/IMG_4443_2.JPG"></img></p>
        </div>
      </p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
